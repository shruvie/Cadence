...
class Signup extends AppCompatActivity {
    ...
    private String databaseUrl = "https://cdproject-18f3a-default-rtdb.asia-southeast1.firebasedatabase.app";
            ...
            mDatabase.child(userId).setValue(user)
                    .addOnCompleteListener(task -> {
                        if (task.isSuccessful()) {
                            ...
                            Log.e("SignupActivity", "Failed to create account: " + task.getException().getMessage(), task.getException());
